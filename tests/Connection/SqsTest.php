...
use Fusio\Adapter\Amazon\Connection\SQS;
...
class SqsTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        /** @var SQS $connectionFactory */
        $connectionFactory = $this->getConnectionFactory()->factory(SQS::class);
        ...
        $this->assertInstanceOf(SqsClient::class, $connection);
    }

    public function testConfigure()
    {
        $connection = $this->getConnectionFactory()->factory(SQS::class);
        $builder    = new Builder();
