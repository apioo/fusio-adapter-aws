...
use Fusio\Adapter\Amazon\Connection\EC2;
...
class EC2Test extends \PHPUnit_Framework_TestCase
{
    ...
    {
        /** @var EC2 $connectionFactory */
        $connectionFactory = $this->getConnectionFactory()->factory(EC2::class);
        ...
        $this->assertInstanceOf(Ec2Client::class, $connection);
    }

    public function testConfigure()
    {
        $connection = $this->getConnectionFactory()->factory(EC2::class);
        $builder    = new Builder();
